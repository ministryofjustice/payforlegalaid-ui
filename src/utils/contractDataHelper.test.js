...
describe("contractDataHelper", () => {
  ...
  it("should generate a sample for a valid endpoint", () => {
    ...
    expect(sample).toHaveBeenCalledWith(
      fakeSwagger.paths["/reports"].get.responses["200"].content["application/json"].schema,
  ...
  it("should throw an error if schema is not found", () => {
    ...
    expect(() => getSampleForPath("/reports", "get", "200")).toThrow("No schema found for /reports get 200")
  })
})
